        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-7xl mx-auto">
          ...
          >
            <CardHeader className="text-center pb-3">
              ...
              <CardTitle className="text-lg font-bold text-gray-800 hover:text-blue-700 transition-colors duration-300">Elenco richieste ambulatori multidisciplinari</CardTitle>
              <CardDescription className="text-gray-600 font-medium text-sm">
                Elenco richieste per ambulatori multidisciplinari
              </CardDescription>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-xs text-gray-500 mb-4 leading-relaxed">
                Visualizza l'elenco completo delle richieste per ambulatori multidisciplinari ordinato per score clinico. 
          ...
          >
            ...
            <CardContent className="text-center flex flex-col grow">
              <p className="text-xs text-gray-500 mb-4 leading-relaxed">
                Cerca in anagrafica, aggiungi informazioni caregiver e compila la checklist.
              </p>
